const CACHE='janma-kundali-v2';
const CORE=['./','./index.html','./assets/css/style.css','./assets/js/app.js','./assets/js/astrology.js','./assets/js/bs-date.js','./src/panchanga.js','./data/locations.json','./manifest.webmanifest'];
